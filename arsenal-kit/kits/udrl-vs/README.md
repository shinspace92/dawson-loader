...
template. UDRL-VS is a library of functions to help support the development of reflective loaders. It is accompanied by three blog posts to explain the rationale behind it and introduce some key concepts. 
...
* `extc2-loader` - a "Double Pulsar" style loader that loads Beacon and an External C2 DLL.
...
**Note:** The UDRL-VS loaders have been tested with Visual Studio Community version `17.11.2`
and the Windows 10 SDK `10.0.22000.0`.
...
As a result, we have created Sleepmask-VS to accompany the UDRL-VS loaders. 
For more information see the README on our public Github:
