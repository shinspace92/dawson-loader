...
/**
* Find the address of a target function within an arbitrary module
*
* @param moduleBaseAddress A pointer to the module's base address
* @param functionHash A hash of the target function's name
* @return A pointer to the target function
*/
ULONG_PTR GetExportedFunctionByHash(ULONG_PTR moduleBaseAddress, DWORD functionHash) {
    // Get the VA of the module's PE Header
    PIMAGE_DOS_HEADER moduleDosHeader = (PIMAGE_DOS_HEADER)moduleBaseAddress;
    PIMAGE_NT_HEADERS modulePEHeader = (PIMAGE_NT_HEADERS)(moduleBaseAddress + moduleDosHeader->e_lfanew);
