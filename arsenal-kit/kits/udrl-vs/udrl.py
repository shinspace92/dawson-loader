...
def cmd_xxd(args):
    ...
    """
    file_output = xxd(args.array_name, args.binary_file.read())
...
def main():
 ...
 | |_| | (_| | |  | |_| |_) | |_| |
  \__,_|\__,_|_|  |_(_) .__/ \__, |
    ...
    parser_xxd.add_argument('--array_name', type=str, default='debug_dll', help='An optional argument to define the output array name. Defaults to debug_dll');
