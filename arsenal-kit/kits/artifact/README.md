...
```
0KB User Defined Reflective Loader size = 372581
...
Stage Size       - integer used to set the space needed for the beacon stage.
                   For a 0K   RDLL stage size should be 372581 or larger
                   For a 5K   RDLL stage size should be 372581 or larger
                   For a 100K RDLL stage size should be 494068 or larger
...
Example: 
```
./build.sh "peek pipe readfile" HeapAlloc 372581 5 true true indirect /tmp/dist
```
